...
$sql = mysqli_query($conn,"SELECT * FROM rps WHERE id='$id'");
        ...
        <section class="content">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Edit RPS</h3>
            ...
            <div class="card-body">
              <div class="card card-info">
                <!-- /.card-header -->
                <!-- form start -->
                <form action="ctrl_edit_rps.php" method="post">
                  <input type="hidden" name="rps_id" value="<?php echo $rps['id'] ?>">
                  <div class="card-body">

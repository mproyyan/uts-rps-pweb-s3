        ...
        <section class="content">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar RPS mata kuliah <?php echo $matkul['matkul'] ?></h3>
            ...
            <div class="card-body">
              <div class="card">
                <div class="card-header">
                  <a href="tambah_rps.php?id=<?php echo $id ?>" class="btn btn-outline-info">Tambah RPS</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body p-0">
                  <table class="table">
                    ...
                    <tbody>
                      <?php
                        $sql = "SELECT * FROM rps WHERE matkul_id = '$id'";
                        $query = mysqli_query($conn, $sql);
                        $nomor = 1;
                        while($rps = mysqli_fetch_array($query)){
                          echo "<tr>";
                          echo "<td>".$nomor."</td>";
                          echo "<td>Pertemuan ke-". $rps['pertemuan'] ."</td>";
                          echo "<td>".$rps['judul']."</td>";
                          echo "<td>".$rps['deskripsi']."</td>";
                          echo "<td>";
                          echo "<a href='edit_rps.php?id=".$rps['id']."'>Edit</a> | ";
                          echo "<a href='ctrl_delete_rps.php?id=".$rps['id']."'>Hapus</a>";
                          echo "</td>";
                          echo "</tr>";
                          $nomor++;
                        }
